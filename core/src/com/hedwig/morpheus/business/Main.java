...
public class Main {
    ...
    public void start() {
        ...
        topicList.add("hw/kitchen/sensors/temperature");
        localBroker.subscribe(topicList);

        Sensor kitchenSensor = new Sensor("kitchen sensor", null, null, "kitchen", "hw/kitchen/sensors/temperature");

        Message message = new Message();
        message.setTo(kitchenSensor);
        message.setPayload("It got hot in here");

        localBroker.sendMessage(message);
...
//            final String certificatesPath = "/home/hugo/Documents/TCC/dev/mqtt/certificates";
